...
const Registration = () => {
  ...
  const saveEnrol = () => {
    setLoading(true);
    const url = "http://localhost:5000/pc/courseregistration";
    axios
  ...
  const saveApprove = () => {
    setLoading1(true);
    const url = "http://localhost:5000/pc/courseregistration/approvestudents";
                ...
                <table className="w-full divide-y divide-gray-200 text-sm text-left sm:rounded-lg">
                  {studentListTable.studentsList && expand && (
                    <tr className="rounded-t-lg bg-gray-100 text-xs uppercase">
                      ...
                      <th className="text-center px-5 py-3 text-gray-600 text-left text-xs font-semibold uppercase tracking-wider"> Approval-FA</th>
                    </tr>
                  )}
                  <tbody className="divide-y divide-gray-200">
