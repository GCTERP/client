...
const Registration = () => {
 ...
 const deleteStudent = (courseCode, ind) => (e) => {
  ...
  const url = "http://localhost:5000/admin/courseregistration/removestudents";
      axios
...
const handleOKClick = (addrow) => {
  ...
  const url = "http://localhost:5000/admin/courseregistration/addstudents";
      axios
        .post(url, addstudent)
        .then((res) => {
...
const handleInput = (e) => {
  ...
  if(enrol === true){
    ...
    const saveEnrol = () => {
      setLoading(true);
      const url = "http://localhost:5000/admin/courseregistration/getdata";
      axios
    ...
    const saveApprove = () => {
      setLoading1(true);
      const url = "http://localhost:5000/admin/courseregistration/approve";
      axios
        .post(url, approve)
        .then((res) => {
          if(res.data.success){
